...
- 👀 **Domain**: Blockchain Technology, Ethereum, Distributed Systems  
- 🧠 **Focus**: Protocols, Smart Contracts, Data Analysis  
- 🎓 **Education**: M.Phil in Computer Science — CUSAT  
- 🧪 **Current Quest**: Blockchain Data Analysis & Research Tooling  
- 🎨 **Side Skills**: 3D Design, Interactive Systems  
- 📚 **Off-chain**: Light novels, world-building, game mechanics  

> I like building systems that *work*.
